...
export default function NotificationsPage () {
  ...
  // Format time to match the dropdown style
  ...
  return (
    <div className='max-w-2xl mx-auto px-4 pt-24 pb-20'>
      {/* Header - matches dropdown style */}
      <div className='mb-4 border-b border-gray-800 pb-3'>
       <div className='flex flex-col'>
    <div className='flex items-center justify-between mb-2'>
      <div className='flex items-center gap-2'>
        <svg className='w-5 h-5 text-[#FDC116]' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
      ...
      <div className='flex items-center gap-3'>
        {/* Refresh button - matches dropdown style */}
        <button
    ...
    {/* Mark all as read button on next line, aligned to right */}
    {hasUnread && (
      ...
      {/* Notifications List - matches dropdown style */}
      <div>
        {notifications.map(n => (
          <div
            key={n._id}
          ...
          >
            <div className='flex gap-3 pb-1 border-b-2 border-gray-600'>
              ...
              {/* Content - matches dropdown layout */}
              <div className='flex-1 min-w-0'>
                <div className='flex justify-between items-start'>
                  <div>
                    {/* Username - same as dropdown */}
                    <Link
                      to={`/u/${n.sender?.username}`}
                    ...
                    {/* Message with icon - same as dropdown */}
                  ...
                  {/* Time and mark as read - matches dropdown */}
                ...
                {/* Preview for notes - matches dropdown */}
                {n.note?.content && (
